        ...
        <section>
            ...
            <div class="alert alert-success centrarDiv">
                ...
                <div class="alert alert-warning centrarDiv">
                    ...
                    <form  action="/SIWAI/ControladorEmpleado" method="post">
                        <div class="container"> 
                            <div class="row">
                            ...
                            <div class="row centrar-texto">
                                ...
                                <div class="col-md-2">
                                    <button  name="registrarEmpleado" type="submit" class="btn btn-success btn-lg letra">Registrar
                                    </button>
                                </div>
                                <div class="col-md-2">
