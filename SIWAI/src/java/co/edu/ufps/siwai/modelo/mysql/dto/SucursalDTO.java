...
public class SucursalDTO {
    ...
    /**
     * Metodo que retorna la ciudad donde se encuentra la sucursal
     * @return String con el nombre de la ciudad donde se encuentra la surcursal
     */
    public String getCiudad() {
        return ciudad;
    }
    /**
     * Metodo que establece la ciudad donde se encuentra la sucursal
     * @param ciudad Ciudad donde se encuentra la sucursal
     */
    ...
    /**
     * Metodo que retorna el pais donde se encuentra la sucursal
     * @return String con el nombre del pais donde se encuentra la surcursal
     */
    public String getPais() {
        return pais;
    }
    /**
     * Metodo que establece el pais donde se encuentra la sucursal
     * @param pais Pais donde se encuentra la sucursal
     */
